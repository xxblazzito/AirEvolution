trigger AvionTrigger on Avion__c (before insert,before update,before delete,after insert,after update, after delete, after undelete) {
    triggerHandler handler = new AvionTriggerHandler(Trigger.isExecuting, Trigger.size);  
